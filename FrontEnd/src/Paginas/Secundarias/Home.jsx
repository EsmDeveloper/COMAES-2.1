          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 sm:px-6 md:px-8">
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                ...
                <button className="bg-blue-600 hover:bg-blue-800 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 md:px-8 rounded-full text-sm sm:text-base md:text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center gap-2 w-full sm:w-auto justify-center">
                ...
                {/* Botão Teste Básico */}
                <button className="bg-blue-700 hover:bg-blue-800 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 md:px-8 rounded-full text-sm sm:text-base md:text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center gap-2 w-full sm:w-auto justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
            {[
              ...
              {
                icon: <FaMoneyBillWave className="text-2xl sm:text-3xl text-blue-600" />,
                title: "Finanças",
